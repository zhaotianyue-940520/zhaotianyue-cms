...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top " style="height: 50px;" >
  <div class="collapse navbar-collapse" id="navbarSupportedContent" >
    ...
    <form class="form-inline my-2 my-lg-0" style="margin-right:30%" action="index" method="get">
      ...
      <button class="btn btn-outline-success my-2 my-sm-0"  type="submit">搜素</button>
    </form>
    ...
    <div>
    	<ul class="nav">
    		...
    		<li class="nav-item nav-link">${sessionScope.user.username}</li>
    		<li class="nav-item dropdown">
		        <a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
		          	用户信息
		        </a>
		            <div class="dropdown-menu" aria-labelledby="navbarDropdown">
			          <a class="dropdown-item" href="${sessionScope.user.role==1?'/admin/index':'/user/home'}">进入个人中心</a>
